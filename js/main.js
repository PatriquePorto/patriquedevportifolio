    ...
    (function($) {
        ...
        let locales = {
            'pt-BR': {
                ...
                'work': { message: 'Sou Freelancer e Desenvolvedor Front-End.'},
                ...
                'xp-web': { message: '4 anos de experiência em Desenvolvimento Web'},
                'html5': { message: '4 anos de experiência em HTML5'},
                'css3': { message: '4 anos de experiência em CSS3'},
                'js-jq': { message: '2 anos de experiência em JavaScript e Jquery'},
                'bootstrap': { message: '2 anos de experiência em BootStrap 4, 5'},
                'skill-bar': { message: 'Barra de Habilidade Progressiva'},
                'prev-b': { message: 'Anterior'},
                'next-b': { message: 'Avançar'},
                'loading-skills': { message: 'Carregando Habilidades...'},
                ...
                'advocacy-page': { message: 'Página de Advocacia' },
                'lawyer-page': { message: 'Landing Page Advogado' },
                'gym-page': { message: 'Site Para Academia' },
            ...
            'en': {
                ...
                'work': { message: "Freelancer and Front-End Developer." },
                ...
                'xp-web': { message: '4 Years experience in Web Development'},
                'html5': { message: '4 years experience in HTML5'},
                'css3': { message: '4 years experience in CSS3'},
                'js-jq': { message: '2 year experience in JavaScript and Jquery'},
                ...
                'lawyer-page': { message: 'Lawyer Landing Page' },
                'advocacy-page': { message: 'Advocacy Page' },
                'gym-page': { message: 'Gym Page' },
